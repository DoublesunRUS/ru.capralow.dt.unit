...
public class TypeTraverser {
	...
	private void processCompilationUnit(ITypeVisitor visitor, ICompilationUnit unit, IProgressMonitor monitor)
			throws JavaModelException {
		visitor.visit(unit);
	...
	private void processClassFile(ITypeVisitor visitor, IClassFile file, IProgressMonitor monitor)
			throws JavaModelException {
		visitor.visit(file);
	...
	private void processAnonymousInnerTypes(ITypeVisitor visitor, BinaryTypeName btn, IMember member,
