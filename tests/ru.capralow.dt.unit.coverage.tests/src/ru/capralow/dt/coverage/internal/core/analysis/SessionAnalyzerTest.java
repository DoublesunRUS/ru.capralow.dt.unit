...
public class SessionAnalyzerTest {
	...
	public void testGetNameNestedSourceFolder() throws CoreException {
		...
		IPackageFragmentRoot source = javaProject.createSourceFolder("src/main/java");
	...
	public void testGetNameProjectRootSourceFolder() throws CoreException {
		IPackageFragmentRoot source = javaProject.javaProject.getPackageFragmentRoot(javaProject.project);
	...
	@Test
	public void testGetNameLocalLibraryInFolder() throws CoreException, IOException {
		...
		IPackageFragmentRoot library = javaProject
				.createJAR("testdata/bin/signatureresolver.jar", "/libs/runtime/sample.jar", null, null);
	...
	public void testGetNameExternalLibrary() throws CoreException, IOException {
		IPackageFragmentRoot library = javaProject.createExternalJAR("testdata/bin/signatureresolver.jar", null, null);
