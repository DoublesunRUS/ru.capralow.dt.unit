...
class AdjustedLaunchConfiguration implements ILaunchConfiguration {
	...
	public ILaunchConfigurationWorkingCopy copy(String name) throws CoreException {
		return new AdjustedLaunchConfigurationWorkingCopy(extraVMArgument, delegate.copy(name), null);
	}

	public ILaunchConfigurationWorkingCopy getWorkingCopy() throws CoreException {
		return new AdjustedLaunchConfigurationWorkingCopy(extraVMArgument, delegate.getWorkingCopy(), this);
	}
	...
	public ILaunchDelegate getPreferredDelegate(@SuppressWarnings("rawtypes") Set modes) throws CoreException {
