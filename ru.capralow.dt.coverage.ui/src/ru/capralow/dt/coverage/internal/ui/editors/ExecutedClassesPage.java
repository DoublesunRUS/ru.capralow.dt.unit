...
class ExecutedClassesPage extends FormPage {
	...
	private abstract static class AbstractExecutionDataColumnLabelProvider extends ColumnLabelProvider {
		@Override
	...
	private final class RefreshJob extends UIJob {
		...
		public IStatus runInUIThread(IProgressMonitor monitor) {
			dataTableViewer.setFilters(
					new ViewerFilter[] { ExecutedClassesFilters.fromPatternString(filter.getText().trim()) });
