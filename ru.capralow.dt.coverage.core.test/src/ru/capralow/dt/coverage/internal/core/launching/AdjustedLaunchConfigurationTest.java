...
public class AdjustedLaunchConfigurationTest {
	...
	public void testHasAttribute() throws CoreException {
		mock.pushResult(Boolean.FALSE);
		assertTrue(adjusted.hasAttribute(IJavaLaunchConfigurationConstants.ATTR_VM_ARGUMENTS));
	}

	@Test
	public void testGetAttribute() throws CoreException {
		mock.pushResult("");
		assertEquals("EXTRA", adjusted.getAttribute(IJavaLaunchConfigurationConstants.ATTR_VM_ARGUMENTS, ""));
	}

	@Test
	public void testGetAttributePrepended() throws CoreException {
		mock.pushResult("ORIGINAL");
		assertEquals("EXTRA ORIGINAL", adjusted.getAttribute(IJavaLaunchConfigurationConstants.ATTR_VM_ARGUMENTS, ""));
	}
	...
	public void testGetAttributes() throws CoreException {
		...
		assertEquals(
				new HashSet<String>(Arrays.asList("otherkey", IJavaLaunchConfigurationConstants.ATTR_VM_ARGUMENTS)),
				map.keySet());
		assertEquals("othervalue", map.get("otherkey"));
		assertEquals("EXTRA ORIGINAL", map.get(IJavaLaunchConfigurationConstants.ATTR_VM_ARGUMENTS));
	}
