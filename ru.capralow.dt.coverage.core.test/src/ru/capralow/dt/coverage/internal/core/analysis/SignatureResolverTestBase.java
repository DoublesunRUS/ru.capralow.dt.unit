...
public abstract class SignatureResolverTestBase {
	...
	private void assertSignature(final String methodName, final String signature) throws Exception {
	...
	public void test_parameterizedType() throws Exception {
		assertSignature("method_parameterizedType", "Lsignatureresolver/Samples$Generic;");
	}

	@Test
	public void test_parameterizedParameterizedType() throws Exception {
		assertSignature("method_parameterizedParameterizedType", "Lsignatureresolver/Samples$Generic;");
	}

	@Test
	public void test_parameterizedTypeWildcard() throws Exception {
		assertSignature("method_parameterizedTypeWildcard", "Lsignatureresolver/Samples$Generic;");
	}

	@Test
	public void test_parameterizedTypeExtends() throws Exception {
		assertSignature("method_parameterizedTypeExtends", "Lsignatureresolver/Samples$Generic;");
	}

	@Test
	public void test_parameterizedTypeSuper() throws Exception {
		assertSignature("method_parameterizedTypeSuper", "Lsignatureresolver/Samples$Generic;");
	}
