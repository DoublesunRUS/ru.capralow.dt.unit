...
### Настройка
Из контекстного меню панели Навигатор установить Фреймворк тестирования. Фреймворк будет добавлен как проект с внешней обработкой.<br>
...
Видео с демонстрацией настройки можно посмотреть [здесь](https://youtu.be/No_BHUo1nSQ).<br>
<br>
