...
public final class UnitTestLaunchConfigurationAttributes
{
    ...
    public static final String EXTENSION_PROJECT_TO_TEST =
        "ru.capralow.dt.launching.core.ATTR_EXTENSION_PROJECT_TO_TEST"; //$NON-NLS-1$
    ...
    public static final String EXTERNAL_OBJECT_DUMP_PATH =
        "ru.capralow.dt.launching.core.ATTR_EXTERNAL_OBJECT_DUMP_PATH"; //$NON-NLS-1$
    public static final String EXTERNAL_OBJECT_STARTUP_OPTIONS =
        "ru.capralow.dt.launching.core.ATTR_EXTERNAL_OBJECT_STARTUP_OPTIONS"; //$NON-NLS-1$
