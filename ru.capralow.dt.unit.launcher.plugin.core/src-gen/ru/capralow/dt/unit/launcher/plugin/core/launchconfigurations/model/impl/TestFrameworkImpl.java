 ...
 * Framework</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link ru.capralow.dt.unit.launcher.plugin.core.launchconfigurations.model.impl.TestFrameworkImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link ru.capralow.dt.unit.launcher.plugin.core.launchconfigurations.model.impl.TestFrameworkImpl#getVersion
 * <em>Version</em>}</li>
 * <li>{@link ru.capralow.dt.unit.launcher.plugin.core.launchconfigurations.model.impl.TestFrameworkImpl#getResourcePath
 * <em>Resource Path</em>}</li>
 * <li>{@link ru.capralow.dt.unit.launcher.plugin.core.launchconfigurations.model.impl.TestFrameworkImpl#getEpfName
 * <em>Epf Name</em>}</li>
 * </ul>
 *
 * @generated
...
public class TestFrameworkImpl extends MinimalEObjectImpl.Container implements TestFramework {
	...
	/**
	 * The cached value of the '{@link #getResourcePath() <em>Resource Path</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getResourcePath()
	 * @generated
	...
	public void setEpfName(String newEpfName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this,
					Notification.SET,
					ulPackage.TEST_FRAMEWORK__EPF_NAME,
					oldEpfName,
					epfName));
	}
	...
	public void setResourcePath(String newResourcePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this,
					Notification.SET,
					ulPackage.TEST_FRAMEWORK__RESOURCE_PATH,
					oldResourcePath,
					resourcePath));
	}
	...
	public void setVersion(String newVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this,
					Notification.SET,
					ulPackage.TEST_FRAMEWORK__VERSION,
					oldVersion,
					version));
	}
