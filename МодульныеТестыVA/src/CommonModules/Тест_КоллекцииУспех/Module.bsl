:successПроцедура ПроверитьВхождениеЭлементаКоллекцииНаИстина(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьВхождениеВКоллекцию(ЭлементКоллекции1, Коллекция, "Элемент входит в коллекцию.");
КонецПроцедуры

// @unit-test:table:success
