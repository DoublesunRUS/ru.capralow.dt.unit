 ...
 */
package ru.capralow.dt.unit.launcher.frameworks;
...
import ru.capralow.dt.unit.launcher.frameworks.gson.FeatureFormat;
import ru.capralow.dt.unit.launcher.frameworks.gson.FeatureSettings;
import ru.capralow.dt.unit.launcher.frameworks.gson.FrameworkMetaTypes;
import ru.capralow.dt.unit.launcher.frameworks.gson.FrameworkSettings;
import ru.capralow.dt.unit.launcher.frameworks.gson.FrameworksList;
import ru.capralow.dt.unit.launcher.frameworks.gson.TestFramework;
import ru.capralow.dt.unit.launcher.internal.UnitLauncherCorePlugin;
    ...
    private static File getResourceFile(URI uri)
    {
        ...
        for (Integer i = 1; i < segments.length - 1; ++i)
        {
            ...
            if (file.exists() && !file.isDirectory())
            {
                ...
                {
                    String msg =
                        MessageFormat.format(Messages.FrameworkUtils_Unable_to_delete_framework_file_0, file.toPath());
