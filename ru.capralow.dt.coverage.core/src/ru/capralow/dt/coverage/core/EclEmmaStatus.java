...
public final class EclEmmaStatus {
	 ...
	 * runtime agent file.
	 */
	public static final EclEmmaStatus NO_LOCAL_AGENTJAR_ERROR = new EclEmmaStatus(5000,
			IStatus.ERROR,
	 ...
	 */
	public static final EclEmmaStatus UNKOWN_LAUNCH_TYPE_ERROR = new EclEmmaStatus(5002,
			IStatus.ERROR,
	 ...
	 */
	public static final EclEmmaStatus MERGE_SESSIONS_ERROR = new EclEmmaStatus(5003,
			IStatus.ERROR,
	 ...
	 */
	public static final EclEmmaStatus EXEC_FILE_CREATE_ERROR = new EclEmmaStatus(5004,
			IStatus.ERROR,
	 ...
	 */
	public static final EclEmmaStatus EXEC_FILE_READ_ERROR = new EclEmmaStatus(5005,
			IStatus.ERROR,
	 ...
	 * Error while reading coverage data file.
	 */
	public static final EclEmmaStatus AGENT_CONNECT_ERROR = new EclEmmaStatus(5006,
			IStatus.ERROR,
	 ...
	 */
	public static final EclEmmaStatus BUNDLE_ANALYSIS_ERROR = new EclEmmaStatus(5007,
			IStatus.ERROR,
	 ...
	 */
	public static final EclEmmaStatus AGENTSERVER_START_ERROR = new EclEmmaStatus(5011,
			IStatus.ERROR,
	 ...
	 */
	public static final EclEmmaStatus AGENTSERVER_STOP_ERROR = new EclEmmaStatus(5012,
			IStatus.ERROR,
	 ...
	 */
	public static final EclEmmaStatus EXECDATA_DUMP_ERROR = new EclEmmaStatus(5013,
			IStatus.ERROR,
	 ...
	 */
	public static final EclEmmaStatus NO_COVERAGE_DATA_ERROR = new EclEmmaStatus(5101,
			IStatus.ERROR,
