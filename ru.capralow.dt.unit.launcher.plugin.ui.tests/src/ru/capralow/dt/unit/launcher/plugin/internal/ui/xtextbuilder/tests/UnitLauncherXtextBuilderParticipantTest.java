package ru.capralow.dt.unit.launcher.plugin.internal.ui.xtextbuilder.tests;

import static org.junit.Assert.assertEquals;

import org.junit.Test;

import ru.capralow.dt.unit.launcher.plugin.internal.ui.xtextbuilder.UnitLauncherXtextBuilderParticipant;
...
public class UnitLauncherXtextBuilderParticipantTest {
	...
	public void testGetUnitTestKeyFromMethodTextKeyOnlyMultiline1() {
		...
		String methodText = String
				.join(System.lineSeparator(), UNIT_TEST, "// Описание процедуры 1", "// Модульное тестирование 1"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void testGetUnitTestKeyFromMethodTextKeyOnlyMultiline2() {
		...
		String methodText = String
				.join(System.lineSeparator(), "// Описание процедуры 2", UNIT_TEST, "// Модульное тестирование 2"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void testGetUnitTestKeyFromMethodTextKeyOnlyMultiline3() {
		...
		String methodText = String
				.join(System.lineSeparator(), "// Описание процедуры 3", "// Модульное тестирование 3", UNIT_TEST); //$NON-NLS-1$ //$NON-NLS-2$
