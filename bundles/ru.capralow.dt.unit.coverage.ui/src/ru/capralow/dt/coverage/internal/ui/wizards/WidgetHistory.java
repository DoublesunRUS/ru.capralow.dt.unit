...
public final class WidgetHistory
{
     ...
     *
     * @param settings dialog setting used to persist the status
     * @param check check box
     */
     ...
     *
     * @param settings dialog setting used to persist the history
     * @param key key used for this combo box
    ...
    /**
     * Restores the selection state of a radio group. If no value was persisted the
     * first button is selected.
     *
     * @param settings dialog setting used to persist the status
     * @param key key used for this radio group
     * @param radios buttons of the radio group
     */
     ...
     *
     * @param settings dialog setting used to persist the value
     * @param key key used for this text field
     * @param text text field
     * @param preset value used if no value was persisted before
     */
     ...
     *
     * @param settings dialog setting used to persist the status
     * @param key key used for this check box
     * @param check check box
     */
    ...
    /**
     * Saves the items of the given combo box as its history. The current text value
     * is added as the most recent history item. The number of history items is
     * limited.
     *
     * @param settings dialog setting used to persist the history
     * @param key key used for this combo box
