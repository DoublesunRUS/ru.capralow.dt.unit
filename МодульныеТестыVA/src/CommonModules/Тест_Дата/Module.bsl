...
Процедура ПроверитьВхождениеДатыВПериодНаИстину(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьДату(ЭталонныйПериод, ПроверяемаяДата, "Дата входит в период.");
КонецПроцедуры
...
Процедура ПроверитьВхождениеДатыВПериодНаЛожь(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьДату(ЭталонныйПериод, ПроверяемаяДата, "Дата ошибочно не входит в период.");
КонецПроцедуры
